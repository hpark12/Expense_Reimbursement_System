...
function approvalStatus() {
    ...
    xhttp.open("POST", "http://localhost:8080/Expense_Reimbursement_System/html/approveRequest.ajax?status=" +
...
function logOutNow() {
    ...
    xhttp.open("POST", "http://localhost:8080/Expense_Reimbursement_System/html/logout.ajax", true);
    xhttp.send();
}
...
function viewAllApproved(){
    ...
    xhttp.open("POST", "http://localhost:8080/Expense_Reimbursement_System/html/viewAllApproved.ajax", true);
    xhttp.send();
}
...
function viewAllPending() {
    ...
    xhttp.open("POST", "http://localhost:8080/Expense_Reimbursement_System/html/viewAllPending.ajax", true);
    xhttp.send();
}
...
function viewAllEmployees() {
    ...
    xhttp.open("POST", "http://localhost:8080/Expense_Reimbursement_System/html/viewAllEmployees.ajax", true);
    xhttp.send();
}
