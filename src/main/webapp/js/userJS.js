...
function insertRequest() {
    ...
    xhttp.open("POST", "http://localhost:8080/Expense_Reimbursement_System/html/insertRequest.ajax?amount=" +
...
function viewApproved() {
    ...
    xhttp.open("POST", "http://localhost:8080/Expense_Reimbursement_System/html/viewApproved.ajax", true);
    xhttp.send();
}
...
function viewPending() {
    ...
    xhttp.open("POST", "http://localhost:8080/Expense_Reimbursement_System/html/viewPending.ajax", true);
    xhttp.send();
}
